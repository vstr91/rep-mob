...
public class ModalPlayerBloco extends android.support.v4.app.DialogFragment implements View.OnClickListener,
    ...
    public TempoBlocoRepertorio getTbr() {
        return tbr;
    }

    public void setTbr(TempoBlocoRepertorio tbr) {
        this.tbr = tbr;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textViewMusica.setText(tbr.getBlocoRepertorio().getNome());
        textViewArtista.setText(tbr.getBlocoRepertorio().getRepertorio().getNome());
        textViewDuracao.setText(DataUtils.toStringSomenteHoras(tbr.getTempo(), 1));
