...
public class TipoEventoDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DBCREATE = "CREATE TABLE tipo_evento (_id integer primary key, nome text NOT NULL, " +
            "status integer NOT NULL, data_cadastro text, data_recebimento text, ultima_alteracao text, id_remoto integer);";
